...
const GenericAuthCancelBankAccountLambda = require('./GenericAuthCancelBankAccountLambda');
...
const issuer = GenericAuthCancelBankAccountLambda.Create({ config: process.env });
