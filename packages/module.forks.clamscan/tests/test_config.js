...
module.exports = {
    ...
    clamdscan: {
        socket: '/tmp/clamd.socket',   // required for testing (change for your system) - can be set to null
        host: null, // '127.0.0.1',                          // required for testing (change for your system) - can be set to null
        port: null, // 3310,                                 // required for testing (change for your system) - can be set to null
